...
const AnalyticsPage = () => {
    ...
    // Remove the early returns for loading and no data, we will render the layout first and show Skeleton inside.
    const renderContent = () => {
        if (loading) return (
        ...
        if (!analyticsData) return (
            <div className="w-full max-w-4xl mx-auto mt-12">
                <EmptyState
                    ...
                    description="Log your first dose from the dashboard to generate your health analytics."
                />
            </div>
        );
